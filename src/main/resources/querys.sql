...
insert into pelicula(id, calificacion, fecha_de_creacion, imagen, titulo, genero_id)
values(3, 5, '2023-04-21', null, 'Pinocho', 4);
insert into pelicula(id, calificacion, fecha_de_creacion, imagen, titulo, genero_id)
values(4, 1, '1965-12-01', null, 'La naranja mecánica', 2);
insert into pelicula(id, calificacion, fecha_de_creacion, imagen, titulo, genero_id)
values(5, 2, '1988-12-25', null, 'Bañeros locos', 3);

select * from personaje;
insert into personaje(id, edad, historia, imagen, nombre, peso)
values(1, 25, 'asdasdsadasdsadasd', null,'Mónica Cif', 48);
insert into personaje(id, edad, historia, imagen, nombre, peso)
values(2, 47, 'asdasdsadasdsadasd', null,'Carlos Poet', 78);
insert into personaje(id, edad, historia, imagen, nombre, peso)
values(3, 17, 'asdasdsadasdsadasd', null,'Roque Blem', 66);
insert into personaje(id, edad, historia, imagen, nombre, peso)
values(4, 63, 'asdasdsadasdsadasd', null,'María Trapo', 95);
insert into personaje(id, edad, historia, imagen, nombre, peso)
values(5, 55, 'asdasdsadasdsadasd', null,'Guillermo Franela', 75);
